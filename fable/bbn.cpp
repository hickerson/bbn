  ...
  */
  ...
  if (is_called_first_time) {
	...
	*/
	...
	static const float zm[] = {
		0.f, 1.f, 1.f, 1.f, 2.f, 2.f, 3.f, 3.f, 4.f, 3.f, 5.f, 4.f,
		5.f, 5.f, 6.f, 5.f, 6.f, 7.f, 6.f, 7.f, 6.f, 7.f, 8.f, 7.f,
		8.f, 8.f
	};
	static const float dm[] = {
		.008665f, .007825f, .014102f, .016050f, .016030f, .002603f,
		.015125f, .016004f, .016929f, .022487f, .024609f, .012186f,
		.012939f, .009305f, .011432f, .014354f, .000000f, .018641f,
		.003354f, .005738f, .003242f, .003074f, .008597f, .000108f,
    ...
    {
      static const float values[] = {
        12, 2, 2, 1, 0, 3, 0.471f, 25.82f, 13, 2,
          3, 1, 0, 4, 1.63f, 72.62f, 14, 2, 5, 1,
          0, 6, 2.61f, 238.81f, 15, 2, 7, 1, 0, 8,
          1.19f, 84.17f, 16, 3, 5, 1, 2, 4, 1.002f,
          8.863f, 17, 3, 9, 1, 2, 8, 0.998f, 19.081f,
          18, 3, 7, 1, 4, 6, 1.070f, 55.494f, 19, 5,
          9, 1, 0, 6, 4.70f, 220.39f, 20, 2, 3, 2,
          0, 5, 1.63f, 63.750f, 21, 2, 4, 2, 0, 6,
          2.61f, 229.932f, 22, 2, 7, 2, 0, 9, 1.19f,
          65.054f
      };
      fem::data_of_type<float> data(FEM_VALUES_AND_SIZE);
      FEM_DO_SAFE(i, 12, 22) {
