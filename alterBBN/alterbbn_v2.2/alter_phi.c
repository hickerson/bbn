...
{ 
	...
	double rhot_phi0,T_RH;

  	if(argc<3) 
  	{ 
		printf(" This program needs 2 parameters:\n"
		"   rhotilde_phi   scalar field density proportion to photon density at initial temperature (~2.3 MeV)\n"
	...
	Init_scalarfield(rhot_phi0,paramrelic.Tinit*K_to_GeV,T_RH*1.e-3,0.,&paramrelic);
