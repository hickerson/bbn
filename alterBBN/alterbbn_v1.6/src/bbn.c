...
/*   reac#      type n1 n2 n3 n4  rev   q   */
	...
	{da_pLi6,   1.,6.,3.,0.,7.,1.53,17.118},	// H2 + a -> p + Li6
	{ta_pLi7,   1.,6.,4.,0.,8.,1.11,28.640},	// H3 + a -> p + Li7
	{ha_pBe7,   1.,6.,5.,0.,9.,1.11,18.423},	// He3 + a -> p + Be7
	{dd_ph,     5.,3.,0.,1.,5.,1.73,37.935},	// H2 + d -> p + He3
	{dd_nt,     5.,3.,0.,2.,4.,1.73,46.798},	// H2 + d -> n + H3
	...
	{B11p_aaBe4,9.,14.,2.,0.,6.,3.50,100.753},	// B11 + p -> 2a + Be4
...
/*   reac# type n1 n2 n3 n4  rev   q 
	...
	{25.,1.,6.,3.,0.,7.,1.53,17.118},	// H2 + a -> p + Li6
	{26.,1.,6.,4.,0.,8.,1.11,28.640},	// H3 + a -> p + Li7
	{27.,1.,6.,5.,0.,9.,1.11,18.423},	// He3 + a -> p + Be7
...
{	
	...
	{	
		...
		for(ie=0;ie<=NNUC;ie++) if(sigma_ratioH[ie]/ratioH[ie]<1.e-10) optfail+=1;
