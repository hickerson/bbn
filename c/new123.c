...
/* ..........READ IN REACTION PARAMETERS. */
	recpr_1.iform[i__ - 1] = (shortint) reacpr_ref(i__, 2);
/* Reaction type. */
	recpr_1.ii[i__ - 1] = (shortint) reacpr_ref(i__, 3);
/* Incoming nuclide type. */
	recpr_1.jj[i__ - 1] = (shortint) reacpr_ref(i__, 4);
/* Incoming nuclide type. */
	recpr_1.kk[i__ - 1] = (shortint) reacpr_ref(i__, 5);
/* Outgoing nuclide type. */
	recpr_1.ll[i__ - 1] = (shortint) reacpr_ref(i__, 6);
/* Outgoing nuclide type. */
...
/* ..........READ IN SELECTION NUMBER. */
    s_rsfe(&io___5);
    do_fio(&c__1, (char *)&inum, (ftnlen)sizeof(shortint));
    e_rsfe();
...
/* ..........DISPLAY RESET SELECTIONS. */
    s_wsfe(&io___36);
    do_fio(&c__1, (char *)&compr_1.cy, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&compr_1.ct, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&varpr_1.dt1, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&compr_1.t9i, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&compr_1.t9f, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&compr_1.ytmin, (ftnlen)sizeof(doublereal));
    d__1 = (doublereal) compr_1.inc;
...
/* Change time step limiting const 1 se */
    ...
    e_wsfe();
    s_rsle(&io___40);
    do_lio(&c__5, &c__1, (char *)&compr_1.cy, (ftnlen)sizeof(doublereal));
    e_rsle();
/* L2101: */
    goto L400;
L220:
/* Change time step limiting const 2 se */
    ...
    e_wsfe();
    s_rsle(&io___42);
    do_lio(&c__5, &c__1, (char *)&compr_1.ct, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L230:
/* Change initial time step section. */
    ...
    e_wsfe();
    s_rsle(&io___44);
    do_lio(&c__5, &c__1, (char *)&varpr_1.dt1, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L240:
/* Change initial temperature section. */
    ...
    e_wsfe();
    s_rsle(&io___46);
    do_lio(&c__5, &c__1, (char *)&compr_1.t9i, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L250:
/* Change final temperature section. */
    ...
    e_wsfe();
    s_rsle(&io___48);
    do_lio(&c__5, &c__1, (char *)&compr_1.t9f, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L260:
/* Change smallest abundances allowed s */
    ...
    e_wsfe();
    s_rsle(&io___50);
    do_lio(&c__5, &c__1, (char *)&compr_1.ytmin, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L270:
/* Change accumulation increment sectio */
    ...
    e_wsfe();
    s_rsle(&io___52);
    do_lio(&c__2, &c__1, (char *)&compr_1.inc, (ftnlen)sizeof(shortint));
    e_rsle();
    goto L400;
L280:
...
/* ..........DISPLAY RESET SELECTIONS. */
    s_wsfe(&io___55);
    do_fio(&c__1, (char *)&modpr_1.c__[0], (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&modpr_1.c__[1], (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&modpr_1.c__[2], (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&varpr_1.eta1, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&modpr_1.cosmo, (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&modpr_1.xi[0], (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&modpr_1.xi[1], (ftnlen)sizeof(doublereal));
    do_fio(&c__1, (char *)&modpr_1.xi[2], (ftnlen)sizeof(doublereal));
    e_wsfe();
/* ..........READ IN SELECTION NUMBER. */
    s_rsfe(&io___56);
    do_fio(&c__1, (char *)&inum, (ftnlen)sizeof(shortint));
...
/* Change gravitational constant sectio */
    ...
    e_wsfe();
    s_rsle(&io___59);
    do_lio(&c__5, &c__1, (char *)&modpr_1.c__[0], (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L220:
/* Change neutron lifetime section. */
    ...
    e_wsfe();
    s_rsle(&io___61);
    do_lio(&c__5, &c__1, (char *)&modpr_1.c__[1], (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L230:
/* Change number of neutrino species se */
    ...
    e_wsfe();
    s_rsle(&io___63);
    do_lio(&c__5, &c__1, (char *)&modpr_1.c__[2], (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L240:
/* Change baryon-to-photon ratio sectio */
    ...
    e_wsfe();
    s_rsle(&io___65);
    do_lio(&c__5, &c__1, (char *)&varpr_1.eta1, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L250:
/* Change cosmological constant section */
    ...
    e_wsfe();
    s_rsle(&io___67);
    do_lio(&c__5, &c__1, (char *)&modpr_1.cosmo, (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L260:
/* Change neutrino degeneracy section. */
    ...
    e_wsfe();
    s_rsle(&io___69);
    do_lio(&c__5, &c__1, (char *)&modpr_1.xi[0], (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L270:
/* Change neutrino degeneracy section. */
    ...
    e_wsfe();
    s_rsle(&io___71);
    do_lio(&c__5, &c__1, (char *)&modpr_1.xi[1], (ftnlen)sizeof(doublereal));
    e_rsle();
    goto L400;
L280:
/* Change neutrino degeneracy section. */
    ...
    e_wsfe();
    s_rsle(&io___73);
    do_lio(&c__5, &c__1, (char *)&modpr_1.xi[2], (ftnlen)sizeof(doublereal));
    e_rsle();
    if (modpr_1.xi[2] != 0. && modpr_1.c__[2] < 3.) {
	modpr_1.c__[2] = 3.;
	s_wsfe(&io___74);
	e_wsfe();
	s_wsfe(&io___75);
...
/* Subroutine */ int run_(void)
{
    ...
    shortint h_dnnt(doublereal *);
    double pow_dd(doublereal *, doublereal *);

    /* Local variables */
    static shortint i__, l, inum[3], jnum, knum, lnum[3];
    static doublereal rnum1[3], rnum2[3], rnum3[3];
    extern /* Subroutine */ int check_(void);
    static shortint inumb;
#define qvary ((doublereal *)&modpr_1 + 3)
    static shortint lnumb1, lnumb2, lnumb3;
    static doublereal rnumb1, rnumb2, rnumb3;
...
/* ..........READ IN SELECTION NUMBER. */
    s_rsfe(&io___82);
    do_fio(&c__1, (char *)&inumb, (ftnlen)sizeof(shortint));
    e_rsfe();
/* 20--------BRANCH TO APPROPRIATE SECTION---------------------------------------- */
    switch (inumb) {
	case 1:  goto L210;
...
L210:
    ...
    e_wsfe();
    s_rsle(&io___85);
    do_lio(&c__2, &c__1, (char *)&inumb, (ftnlen)sizeof(shortint));
    e_rsle();
/* Read in selection number. */
...
/* (irun.eq.1) */
    s_wsfe(&io___86);
    do_fio(&c__1, (char *)&runopt_1.irun, (ftnlen)sizeof(shortint));
    e_wsfe();
    s_rsle(&io___87);
    e_rsle();
    goto L300;
...
L230:
    ...
    e_wsfe();
    s_rsle(&io___92);
    do_lio(&c__2, &c__1, (char *)&jnum, (ftnlen)sizeof(shortint));
    e_rsle();
...
/* ..........OBTAIN QUANTITY TO VARY. */
	    ...
	    e_wsfe();
	    s_rsfe(&io___101);
	    do_fio(&c__1, (char *)&inum[i__ - 1], (ftnlen)sizeof(shortint));
	    e_rsfe();
...
L231:
		...
		e_wsfe();
		s_rsle(&io___105);
		do_lio(&c__5, &c__1, (char *)&rnum1[i__ - 1], (ftnlen)sizeof(
			doublereal));
		e_rsle();
/* Read in starting value. */
		...
		e_wsfe();
		s_rsle(&io___107);
		do_lio(&c__5, &c__1, (char *)&rnum2[i__ - 1], (ftnlen)sizeof(
			doublereal));
		e_rsle();
...
L232:
		...
		e_wsfe();
		s_rsle(&io___109);
		do_lio(&c__5, &c__1, (char *)&rnum3[i__ - 1], (ftnlen)sizeof(
			doublereal));
		e_rsle();
...
/* Trouble with 0 division later on */
		...
		s_wsfe(&io___111);
		do_fio(&c__1, (char *)&rnum1[i__ - 1], (ftnlen)sizeof(
			doublereal));
		do_fio(&c__1, (char *)&rnum2[i__ - 1], (ftnlen)sizeof(
			doublereal));
		do_fio(&c__1, (char *)&rnum3[i__ - 1], (ftnlen)sizeof(
			doublereal));
		e_wsfe();
/* Display inp */
		s_wsfe(&io___112);
...
/* Proper selection was made. */
		...
		do_fio(&c__1, (char *)&rnum1[l - 1], (ftnlen)sizeof(
			doublereal));
		do_fio(&c__1, (char *)&rnum2[l - 1], (ftnlen)sizeof(
			doublereal));
		do_fio(&c__1, (char *)&rnum3[l - 1], (ftnlen)sizeof(
			doublereal));
		e_wsfe();
/* Display run */
...
/* Work with exponents for eta incre */
		    rnum1[l - 1] = d_lg10(&rnum1[l - 1]);
		    rnum2[l - 1] = d_lg10(&rnum2[l - 1]);
		}
	    }
	}
/* ..........COMPUTE NUMBER OF RUNS FOR EACH LOOPING. */
	for (l = 1; l <= 3; ++l) {
	    d__1 = (rnum2[l - 1] - rnum1[l - 1] + rnum3[l - 1]) / rnum3[l - 1]
		    ;
	    lnum[l - 1] = h_dnnt(&d__1);
	}
/* ..........DO MULTIPLE RUNS. */
	s_wsfe(&io___118);
	e_wsfe();
/* Inform user of beginning of computat */
	s__1 = lnum[0] - 1;
	for (lnumb1 = 0; lnumb1 <= s__1; ++lnumb1) {
/* Outer loop. */
	    rnumb1 = rnum1[0] + (doublereal) lnumb1 * rnum3[0];
/* Value of param fo */
	    if (inum[0] >= 1 && inum[0] <= 8) {
		if (inum[0] == 1) {
		    varpr_1.eta1 = pow_dd(&c_b255, &rnumb1);
...
/* Vary other quantities. */
	    ...
	    s__2 = lnum[1] - 1;
	    for (lnumb2 = 0; lnumb2 <= s__2; ++lnumb2) {
/* Middle loop. */
		rnumb2 = rnum1[1] + (doublereal) lnumb2 * rnum3[1];
/* Value of param */
		if (inum[1] >= 1 && inum[1] <= 8) {
		    if (inum[1] == 1) {
			varpr_1.eta1 = pow_dd(&c_b255, &rnumb2);
/* Vary baryon-to-photon ratio. */
		    } else {
...
/* Vary other quantities. */
		...
		s__3 = lnum[2] - 1;
		for (lnumb3 = 0; lnumb3 <= s__3; ++lnumb3) {
/* Inner loop. */
		    rnumb3 = rnum1[2] + (doublereal) lnumb3 * rnum3[2];
/* Value of para */
		    if (inum[2] >= 1 && inum[2] <= 8) {
			if (inum[2] == 1) {
			    varpr_1.eta1 = pow_dd(&c_b255, &rnumb3);
/* Vary baryon-to-photon ratio. */
			} else {
...
/* ..........PRINT HEADINGS, ABUNDANCES FOR NEUTRON TO LI8. */
    ...
    for (j = 1; j <= s__1; ++j) {
	s_wsfe(&io___136);
	do_fio(&c__1, (char *)&outdat_1.t9out[j - 1], (ftnlen)sizeof(
		doublereal));
	for (i__ = 1; i__ <= 10; ++i__) {
	    do_fio(&c__1, (char *)&xout_ref(j, i__), (ftnlen)sizeof(
		    doublereal));
	}
	e_wsfe();
    }
/* ..........PRINT THERMODYNAMIC QUANTITIES. */
	...
	do_fio(&c__1, (char *)&outdat_1.t9out[j - 1], (ftnlen)sizeof(
		doublereal));
	do_fio(&c__1, (char *)&outdat_1.tout[j - 1], (ftnlen)sizeof(
		doublereal));
	for (i__ = 1; i__ <= 5; ++i__) {
	    do_fio(&c__1, (char *)&thmout_ref(j, i__), (ftnlen)sizeof(
		    doublereal));
	}
	do_fio(&c__1, (char *)&outdat_1.dtout[j - 1], (ftnlen)sizeof(
		doublereal));
	do_fio(&c__1, (char *)&outdat_1.etaout[j - 1], (ftnlen)sizeof(
		doublereal));
	do_fio(&c__1, (char *)&outdat_1.hubout[j - 1], (ftnlen)sizeof(
		doublereal));
	e_wsfe();
    }
    s_wsfe(&io___140);
...
/* ..........PRINT HEADINGS, ABUNDANCES FOR D,T,HE3,HE4,LI7. */
	...
	do_fio(&c__1, (char *)&xout_ref(j, 8), (ftnlen)sizeof(doublereal));
	e_wsfe();
    }
    s_wsfe(&io___150);
    e_wsfe();
...
/* ..........PRINT HEADINGS, ABUNDANCES FOR N,P,LI6,BE7,LI8&UP. */
	...
	do_fio(&c__1, (char *)&xout_ref(j, 7), (ftnlen)sizeof(doublereal));
...
/* ..........PRINT THERMODYNAMIC QUANTITIES. */
	...
	do_fio(&c__1, (char *)&outdat_1.tout[j - 1], (ftnlen)sizeof(
		doublereal));
	do_fio(&c__1, (char *)&thmout_ref(j, 5), (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&outdat_1.dtout[j - 1], (ftnlen)sizeof(
		doublereal));
	do_fio(&c__1, (char *)&outdat_1.etaout[j - 1], (ftnlen)sizeof(
		doublereal));
