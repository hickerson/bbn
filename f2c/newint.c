...
/* Add tritium to helium-3. */
	xout_ref(flags_1.it, 6) = xout_ref(flags_1.it, 6) - 3e-4f;
/* my correction for fitted rates+coarse steps */
	...
	do_fio(&c__1, (char *)&outdat_1.etaout[flags_1.it - 1], (ftnlen)
		sizeof(real));
	do_fio(&c__1, (char *)&xout_ref(flags_1.it, 3), (ftnlen)sizeof(real));
	do_fio(&c__1, (char *)&xout_ref(flags_1.it, 5), (ftnlen)sizeof(real));
	do_fio(&c__1, (char *)&xout_ref(flags_1.it, 6), (ftnlen)sizeof(real));
	do_fio(&c__1, (char *)&xout_ref(flags_1.it, 8), (ftnlen)sizeof(real));
	e_wsfe();
